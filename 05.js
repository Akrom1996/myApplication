...
async function main(traderId) {
    try {
        ...
        //const getState = await contract.submitTransaction("getHistory", "nodeA_asset1");//updateBalance
        // const getState = await contract.submitTransaction("updateBalance", traderId, "200000");//updateBalance
        const getState = await contract.submitTransaction("getState", "Akrom");//updateBalance
